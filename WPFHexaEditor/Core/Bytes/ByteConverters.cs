    ...
    public static class ByteConverters
    {
        ...
        public static byte[] HexToByte(string hex)
        {
            ...
            for (var i = 0; i < hexArray.Length; i++)
            {
                ...
                var result = HexToUniqueByte(hexValue);

                if (result == null)
                    return null;

                byteArray[i] = result.Value;
            }
        ...
        /// </summary>
        public static byte? HexToUniqueByte(string hex)
        {
            if(byte.TryParse(hex, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out var val)){
                return val;
            }
        ...
        /// </summary>
        public static long? IsHexValue(string hexastring) => HexLiteralToLong(hexastring);

        
        /// <summary>
        /// Check if is an hexa byte string
        /// </summary>
        public static byte[] IsHexaByteStringValue(string hexastring) => HexToByte(hexastring);
